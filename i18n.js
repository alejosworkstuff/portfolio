const translations = {
  ...
  es: {
    ...
    saravaTitle: "Saravá Radio Streaming",
    saravaProblem: "Crear un mockup listo para comision con secciones claras y navegacion simple.",
    saravaStack: "Next.js App Router, React, TypeScript, CSS.",
    saravaOutcome: "Entregue un mockup estatico pulido con multiples paginas y un inicio tipo feed.",
