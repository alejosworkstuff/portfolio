const translations = {
  en: {
    ...
    miniEcomImpact: "Impact: End-to-end shopping flow from browse to checkout.",
    ...
    skillsDataTitle: "Data and UI Logic",
    skillsDeliveryTitle: "Delivery",
    skillsFrontendList: "HTML, CSS, JavaScript, React, Next.js, TypeScript",
    skillsBackendList: "Node.js, Serverless Functions, REST APIs, External APIs",
    skillsDataList: "JSON, Filtering, Search, State Management, Error Handling",
    skillsDeliveryList: "Git, Vercel, Tailwind CSS, AI tools, IDEs, Documentation",
    aboutTitle: "About",
    aboutBody: "I build end-to-end web products with clean, maintainable code and strong UX. I care about speed, clarity, and shipping things people actually want to use.",
    aboutHighlight: "Focus: clean UI, fast iteration, and user-first flows.",
  ...
  es: {
    ...
    heroLede1: "Diseño y desarrollo aplicaciones full-stack con UX sólida, arquitectura clara y foco en resultados reales.",
    ...
    miniEcomProblem: "Construir un flujo realista de tienda con exploración, carrito y estados de checkout.",
    miniEcomStack: "Next.js App Router, React, TypeScript, Context API, Tailwind CSS.",
    miniEcomOutcome: "Entregué una experiencia completa de checkout simulado con comportamiento de carrito confiable.",
    miniEcomImpact: "Impacto: Flujo de compra end-to-end desde exploración hasta checkout.",
    ...
    skillsFrontendTitle: "Frontend",
    skillsBackendTitle: "Backend",
    skillsDataTitle: "Datos y lógica de UI",
    skillsDeliveryTitle: "Entrega",
    skillsFrontendList: "HTML, CSS, JavaScript, React, Next.js, TypeScript",
    skillsBackendList: "Node.js, Funciones Serverless, REST APIs, APIs externas",
    skillsDataList: "JSON, Filtros, Búsqueda, Manejo de estado, Manejo de errores",
    skillsDeliveryList: "Git, Vercel, Tailwind CSS, IA, IDEs, Documentación",
    aboutTitle: "Sobre mi",
    aboutBody: "Construyo productos web end-to-end con código limpio, mantenible y UX fuerte. Me importa la velocidad, la claridad y entregar cosas que la gente quiera usar.",
    aboutHighlight: "Foco: UI limpia, iteración rápida y flujos centrados en el usuario.",
